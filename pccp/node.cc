...
void Node::SetNodeOption(Ptr<NodeOption> nodeOption){
  m_nodeOption = nodeOption;
}

Ptr<NodeOption> Node::GetNodeOption(void) const {
  return m_nodeOption;
}

void Node::SetParentNode(Ptr<Node> node){
  m_parent = node;
}

Ptr<Node> Node::GetParentNode(void) const{
  return m_parent;
}

void Node::SetPrevNode(Ptr<Node> node){
  m_prev = node;
}
Ptr<Node> Node::GetPrevNode(void) const{
  return m_prev;
}

// Time Node::GetEntrTimeInMac(void) const{
//   return Simulator::Now();
// }
// void Node::SetEntrTimeInMac(Time time){
//   //m_entrTimeInMac = time;
// }  

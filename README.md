...
4. PCCP measures congestion level(degree) for each node by calculating <code><b>packet inter-arrival time</b></code>
   & <code><b>packet service time</b></code> which reflects the present congestion condition.
